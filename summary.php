                    ...
                    <div class="card">
                        <div class="header">
                            <h2><br>
                               ...
                               <a href="profile.php" class="btn btn-warning btn-lg hideme pull-right">Finish</a>
                            </h2>
...
<br>
<?php 
 $query1=mysqli_query($con,"select * from package where package_id='$pid'")or die(mysqli_error($con));
      $row1=mysqli_fetch_array($query1);
        $pname=$row1['package_name'];

        if ($pname=="Custom")
        {
            include('summary_custom.php');
        }
        else
        {
            include('summary_reg.php');
        }
?>
