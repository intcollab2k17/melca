        ...
        <div class="container-fluid" style="width: 100%;margin-left: -160px">
            ...
            <div class="row clearfix">
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" style="margin: 0px 100px">
                    <form role="form" action="menu_save.php" method="post" name="package2" >
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
...
?>        
                    <div class="col-md-3">
                        <div class="">
                            <span class="">
                                <input type="checkbox" id="menu[<?php echo $menu_id;?>]" name="menu[]" value="<?php echo $menu_id;?>" onclick="return KeepCount()">
                                <label for="menu[<?php echo $menu_id;?>]"><?php echo $menu_name;?></label>
                            </span>   
                        </div>
                    </div>           
<?php   
