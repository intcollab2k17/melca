...
?>               
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <h3>Select Custom Menu</h3>
                             <div class="row clearfix">  
                             <input type="hidden" name="package" value="Custom">
                                
<?php
    $query=mysqli_query($con,"select * from category where cat_name='Dessert' or cat_name='Drinks' or cat_name='Snack' order by cat_name")or die(mysqli_error($con));
                    ...
                    <div class="col-md-3">
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon">
                                ...
                                <label for="ig_checkbox<?php echo $menu_id;?>"><?php echo $menu_name;?> (<?php echo $price;?>)</label>
                            </span>   
                        </div>
                    </div>           
<?php   
