...
include('dbcon.php');
        ...
        $query=mysqli_query($con,"select * from user order by last, first")or die(mysqli_error($con));
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" method="post" action="user_update.php" enctype='multipart/form-data'>
                              ...
                              <div class="form-group">
                                   <div class="form-line">
                                        <input type="text" class="form-control" placeholder="Last Name" name="last" value="<?php echo $row['last'];?>">
                                   </div>
                              </div>
                               <!-- Title -->
                              <div class="form-group">
                                   <div class="form-line">
                                        <input type="text" class="form-control" placeholder="First Name" name="first" value="<?php echo $row['first'];?>">
                                   </div>
                              </div>
                               <!-- Title -->
                              <div class="form-group">
            ...
            <div class="modal-body" style="height:140px">
              ...
              <form class="form-horizontal" method="post">
                  ...
                  <div class="alert alert-danger">
                      Are you sure you want to delete <?php echo $row['last'].", ".$row['first'];?>?
                    </div>                     
                  <!-- Buttons -->
                  <div class="form-group">
                      <!-- Buttons -->
