...
include('dbcon.php');
        ...
        $query=mysqli_query($con,"select * from occasion order by occasion")or die(mysqli_error($con));
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" method="post" action="occasion_update.php" enctype='multipart/form-data'>
                              <!-- Title -->
                              <input type="hidden" name="id" value="<?php echo $id;?>">
                              <!-- Title -->
                              <div class="form-group">
                                   <div class="form-line">
                                        <input type="text" class="form-control" placeholder="Occasion Name" name="occasion" value="<?php echo $occasion;?>">
                                   </div>
                              </div>
            ...
            <div class="modal-body" style="height:140px">
              ...
              <form class="form-horizontal" method="post">
                  ...
                  <div class="alert alert-danger">
                      Are you sure you want to delete <?php echo $occasion;?>?
                    </div>                     
                  <!-- Buttons -->
                  <div class="form-group">
                      <!-- Buttons -->
            ...
            <div class="modal fade" id="add" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" method="post" action="occasion_save.php" enctype='multipart/form-data'>
                              <!-- Title -->
                              <div class="form-group">
                                   <div class="form-line">
                                        <input type="text" class="form-control" placeholder="Occasion Name" name="occasion">
                                   </div>
                              </div>
...
<?php
  ...
  // sending query
  mysqli_query($con,"delete from occasion WHERE occasion_id='$id'")
  or die(mysqli_error());
