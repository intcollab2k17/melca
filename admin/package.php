                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                               ...
                               <div class="col-sm-3">
                                <h2 class="card-inside-title">Package Inclusion</h2>
                                    <div class="form-group" style="margin-left:3px;width: 98%">
                                        <div class="form-line">
                                            <input type="number" class="form-control" placeholder="Package Inclusion" name="inclusion" required />
                                        </div>
                                    </div>
                            ...
                            <div class="button-demo text-right">
                                <button type="submit" class="btn btn-lg btn-primary waves-effect">SAVE</button>
