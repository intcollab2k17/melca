...
include('dbcon.php');
    $date11=date('Y-m-d');
    $end11=date("Y-m-d",strtotime($date11. " + 7 days"));
        $query=mysqli_query($con,"select * from reservation natural join customer where reserve_status='Approved' and reserve_date>='$date11' and reserve_date<='$end11' order by reserve_date")or die(mysqli_error($con));
...
?>                      
                      <tr>
                        ...
                        <td>
                              <a href="send.php?id=<?php echo $id;?>" class="btn btn-success waves-effect">Remind</a>
