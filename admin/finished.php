...
include('dbcon.php');
        $date=date("Y-m-d");
        $query=mysqli_query($con,"select * from reservation natural join customer where reserve_status='Approved' and reserve_date<'$date' order by date_reserved")or die(mysqli_error($con));
